...
public class ListDropDownAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.item_default_drop_down2, null);
    ...
    private void fillValue(int position, ViewHolder viewHolder) {
        ...
        if (checkItemPosition != -1) {
            if (checkItemPosition == position) {
                ...
                //viewHolder.mText.setBackgroundResource(com.zxl.library.R.color.check_bg);
            } else {
                viewHolder.mText.setTextColor(context.getResources().getColor(com.zxl.library.R.color.drop_down_unselected));
               // viewHolder.mText.setBackgroundResource(com.zxl.library.R.color.white);
            }
        }
    }
